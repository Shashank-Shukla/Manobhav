...
export function GoogleAuthButton({ onClick }: GoogleAuthButtonProps) {
  return (
    <Button type="button" variant="secondary" className="w-full gap-3 text-sm" onClick={onClick}>
      <GoogleLogo />
      <span>Google</span>
    </Button>
  );
...
function GoogleLogo() {
  return (
    <svg aria-hidden="true" focusable="false" className="h-5 w-5 shrink-0" viewBox="0 0 24 24">
      <path
        fill="#4285F4"
