...
const OnboardingProviderPage = lazy(() => import('./pages/onboarding/OnboardingProviderPage'));
const OnboardingPatientPage = lazy(() => import('./pages/onboarding/OnboardingPatientPage'));
const DashboardProviderPage = lazy(() => import('./pages/dashboard/DashboardProviderPage'));
const DashboardPatientPage = lazy(() => import('./pages/dashboard/DashboardPatientPage'));
